    ...
    function $(e, t, r, n, a) {
      ...
      switch (l.status) {
        ...
        default:
          return (
            M
              ? ((M.errored = !0), (M.value = null), (M.reason = l.reason))
              : (M = {
                  parent: null,
                  chunk: null,
                  value: null,
            ...
            ? (r[0] === p
                ? ((t = {
                  ...
                  null !== M &&
                    ((M = (r = M).parent),
                    r.errored
                      ? (t = x((t = new S("rejected", null, r.reason))))
                      : 0 < r.deps &&
                      ...
                      switch (((l = i += t.decode(u)), n)) {
                        ...
                        case 69:
                          (u = (n = e._chunks).get(r)),
                            ...
                            u
                              ? N(e, u, t)
                              : ((e = new S("rejected", null, t)), n.set(r, e));
                          break;
                        case 84:
    ...
    async function e_(e, t, r, n, a) {
      ...
      try {
        ...
        let [P, T] = await Promise.all([
          ...
          D = (0, _.normalizeFlightData)(P.f);
        if ("string" == typeof D) return eg(a, Date.now() + 1e4), null;
        let M = (0, b.convertServerPatchToFullTree)(
          N,
          n,
          D,
          i,
        ...
        async ({
          ...
          if (void 0 !== s)
            if ((0, O.isExternalURL)(s))
              return n(D(s.href, g)), (0, P.completeHardNavigation)(e, s, g);
            else {
