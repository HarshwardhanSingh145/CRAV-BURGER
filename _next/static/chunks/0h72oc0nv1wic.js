(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (t) => {
    ...
    var n,
      ...
      tT = function (t) {
        var e,
          r,
          n = t[0];
        if ((j(n) || N(n) || (t = [t]), !(e = (n._gsap || {}).harness))) {
          for (r = tx.length; r-- && !tx[r].targetTest(n); );
          e = tx[r];
        }
        for (r = t.length; r--; )
          (t[r] && (t[r]._gsap || (t[r]._gsap = new ej(t[r], e)))) ||
            t.splice(r, 1);
        return t;
      },
      tw = function (t) {
      ...
      t0 = function (t, e) {
        return (
          (ti.ScrollTrigger || to("scrollTrigger", e)) &&
      ...
      t9 = function (t) {
        return t instanceof eW ? tq(t) : t6(t, t._dur);
      },
          ...
          function (e) {
            ...
            return ea(
              ...
              r.querySelectorAll
                ? r
                : r === t
                ? tu("Invalid scope") || O.createElement("div")
                : t
            );
          }
        );
      ...
      ew = function (t, e, r) {
        ...
        if (!p) {
          if (("," === t.substr(-1) && (t = t.substr(0, t.length - 1)), eb[t]))
            p = eb[t];
          else if ("#" === t.charAt(0)) {
            if (
              (t.length < 6 &&
            ...
            if (((p = h = t.match(Q)), e)) {
              ...
              (a = (p[0] % 360) / 360),
                ...
                (p[1] = eT(a, n, i)),
                (p[2] = eT(a - 1 / 3, n, i));
          else p = t.match(Q) || eb.transparent;
          p = p.map(Number);
        }
        return (
          e &&
            ...
            ((n = p[0] / 255),
            (u =
              ((l = Math.max(n, (i = p[1] / 255), (s = p[2] / 255))) +
                (c = Math.min(n, i, s))) /
              2),
            l === c
              ? (a = o = 0)
      ...
      eP =
        ...
        (u = {
          ...
          sleep: function () {
            (o ? cancelAnimationFrame : clearTimeout)(s), (E = 0), (a = tc);
          },
          ...
          add: function (t, e, r) {
            var n = e
              ...
              : t;
            return u.remove(t), v[r ? "unshift" : "push"](n), eE(), n;
          },
          remove: function (t, e) {
      ...
      ez = function (t) {
        for (
          ...
          (r = s[o]),
            ...
            (n = r.substr(0, e)),
            (i[a] = isNaN(n) ? n.replace(eD, "").trim() : +n),
            (a = r.substr(e + 1).trim());
        return i;
      },
      eF = function (t) {
      ...
      eL = function (t) {
        ...
        return r && e.length > 1 && r.config
          ? r.config.apply(
              null,
              ~t.indexOf("{") ? [ez(e[1])] : eF(t).split(",").map(tD)
            )
          : eA._CE && eR.test(t)
          ? eA._CE("", t)
          : r;
        ...
        return (
          ...
          (e.totalTime = function (t, e) {
            ...
            if (r && r.smoothChildTiming && this._ts) {
              for (
                tQ(this, t), !r._dp || r.parent || tZ(r, this);
                r && r.parent;
          ...
          (e.repeat = function (t) {
            return arguments.length
              ? ((this._repeat = t === 1 / 0 ? -2 : t), t9(this))
              : -2 === this._repeat
              ? 1 / 0
              : this._repeat;
          }),
          (e.repeatDelay = function (t) {
            if (arguments.length) {
              var e = this._time;
              return (this._rDelay = t), t9(this), e ? this.time(e) : this;
            }
            return this._rDelay;
          }),
          (e.yoyo = function (t) {
          ...
          (e.restart = function (t, e) {
            return (
              this.play().totalTime(t ? -this._delay : 0, q(e)),
    ...
    var eW = (function (t) {
      ...
      return (
        ...
        (i.staggerFrom = function (t, e, r, n, i, s, a) {
          return (
            (r.runBackwards = 1),
            (tY(r).immediateRender = q(r.immediateRender)),
        ...
        (i.staggerFromTo = function (t, e, r, n, i, s, a, o) {
          return (
            (n.startAt = r),
            (tY(n).immediateRender = q(n.immediateRender)),
        ...
        (i.render = function (t, e, r) {
          ...
          if (
            ...
            if (n >= _ && t >= 0)
              ...
              for (var k = t < 0 ? t : n; i; ) {
                if (
                  ((s = i._prev), (i._act || k <= i._end) && i._ts && l !== i)
                ) {
                  if (i.parent !== this) return this.render(t, e, r);
                  if (
                    (i.render(
            ...
            if (
              ...
              return (this._start = f), tK(this), this.render(t, e, r);
        ...
        (i.add = function (t, e) {
          var r = this;
          if ((X(e) || (e = t7(this, e, t)), !(t instanceof eq))) {
            if (G(t))
              return (
                t.forEach(function (t) {
                  return r.add(t, e);
        ...
        (i.addPause = function (t, e, r) {
          ...
          return (
            (n.data = "isPause"), (this._hasPause = 1), tJ(this, n, t7(this, t))
          );
        }),
        (i.removePause = function (t) {
          var e = this._first;
          for (t = t7(this, t); e; )
            e._start === t && "isPause" === e.data && tj(e), (e = e._next);
        }),
          ...
          if (this._dirty) {
            for (n = this.parent; s; )
              (e = s._prev),
                ...
                (s = e);
            t6(this, this === w && this._time > i ? this._time : i, 1, 1),
              (this._dirty = 0);
          }
          return this._tDur;
        }),
        (n.updateRoot = function (t) {
          if ((w._ts && (tR(w, t$(t, w)), (S = eP.frame)), eP.frame >= ty)) {
            ty += A.autoSleep || 120;
            var e = w._first;
            if ((!e || !e._ts) && A.autoSleep && eP._listeners.length < 2) {
    ...
    var eH,
      ...
      eJ = function (t, e, r, n, i, s, a, o, u, l) {
        ...
        if (
          ...
          return isNaN(h * n) || "" === n
            ? (f || e in t || to(e, n),
              eZ.call(this, t, e, h, n, p, o || A.stringFilter, u))
            : ((c = new rp(
                this._pt,
                t,
                e,
      ...
      e0 = function (t, e, r, n, i) {
        if (
          (N(t) && (t = e6(t, i, e, r, n)),
          !j(t) || (t.style && t.nodeType) || G(t) || V(t))
        )
      ...
      e1 = function (t, e, r, n, i, s) {
        ...
        if (
          ...
          !1 !==
            (a = new tm[t]()).init(
              i,
              a.rawVars ? e[t] : e0(e[t], n, i, s, r),
              r,
              n,
              s
            ) &&
          ((r._pt = o = new rp(r._pt, i, t, 0, 1, a.render, a, 0, a.priority)),
          r !== P)
        )
          for (
      ...
      e2 = function t(e, r, n) {
        var i,
          ...
          D = e._targets,
          z = e.parent,
          F = z && "nested" === z.data ? z.vars.targets : D,
        ...
        if (
          (!I || (S && v) || (v = "none"),
          (e._ease = eB(v, R.ease)),
          (e._rEase = B && (eB(B) || e._ease)),
          (e._from = !I && !!m.runBackwards),
          e._from && (e.ratio = 1),
          !I || (S && !m.stagger))
        ) {
          if (
            ((_ = (f = D[0] ? tw(D[0]).harness : 0) && m[f.prop]),
            (i = tB(m, td)),
            A &&
            ...
            if (
              ...
              (e._startAt._dp = 0),
              (e._startAt._sat = e),
              r < 0 && (b || (!T && !P)) && e._startAt.revert(th),
              T && E && r <= 0 && n <= 0)
            ) {
              r && (e._zTime = r);
              return;
          ...
          for (
            s = 0, e._pt = e._ptCache = 0, k = (E && q(k)) || (k && !E);
            s < D.length;
            s++
          ) {
            if (
              ((c = (u = D[s])._gsap || tT(D)[s]._gsap),
              (e._ptLookup[s] = p = {}),
              tg[c.id] && t_.length && tE(),
              (d = F === D ? s : F.indexOf(u)),
              f &&
                !1 !== (h = new f()).init(u, _ || i, e, d, F) &&
                ((e._pt = o =
                  new rp(e._pt, u, h.name, 0, 1, h.render, h, 0, h.priority)),
              ...
              for (a in i)
                tm[a] && (h = e1(a, i, e, d, u, F))
                  ? h.priority && (l = 1)
                  : (p[a] = o =
                      eJ.call(e, u, a, "get", i[a], d, F, 0, m.stringFilter));
    ...
    var e7 = (function (t) {
      function n(r, n, i, s) {
        ...
        var a,
          ...
          M = _.scrollTrigger,
          O = n.parent || w,
          C = (G(r) || V(r) ? X(r[0]) : "length" in n) ? [r] : ea(r);
        if (
          ((d._targets = C.length
            ? tT(C)
            : tu(
          ...
          var S = (n = d.vars).easeReverse || n.yoyoEase;
          if (
            ((a = d.timeline =
              new eW({
                data: "nested",
            ...
            if (G(T))
              ...
              for (c in u)
                for (
                  ...
                  ((R = {
                    ease: (E = P[o]).e,
                    duration: ((E.t - (o ? P[o - 1].t : 0)) / 100) * g,
                  })[c] = E.v),
                    a.to(C, R, D),
                    (D += R.duration);
        ...
        return (
          !0 !== b || x || ((eK = e(d)), w.killTweensOf(C), (eK = 0)),
          tJ(O, e(d), i),
      ...
      return (
            ...
            if (
              ...
              if (this._rEase) {
                ...
                this.ratio = l =
                  this._invRatio +
                  this._invScale *
                    this._invEase((n - this._invTime) * this._invRecip);
              ...
              (c &&
                ...
                this._onUpdate &&
                  !e &&
                  (d && tH(this, t, e, r), em(this, "onUpdate")),
                this._repeat &&
                  s !== o &&
                  this.vars.onRepeat &&
                  !e &&
                ...
                (_ === this._tDur || !_) &&
                  this._tTime === _ &&
                  (d && !this._onUpdate && tH(this, t, !0, !0),
                  (t || !p) &&
        ...
        (i.kill = function (t, e) {
          ...
          if (this.timeline) {
            ...
            return (
              this.timeline.killTweensOf(t, e, eK && !0 !== eK.vars.overwrite)
                ._first || ev(this),
              this.parent &&
          ...
          for (
            ...
            if (~f.indexOf(c[l]))
              ...
              a))
                (u = i && i[o]) &&
                  (("kill" in u.d && !0 !== u.d.kill(o)) || tU(this, u, "_pt"),
                  delete i[o]),
                  "all" !== s && (s[o] = 1);
    ...
    var rd = [],
      ...
      rw = {
        ...
        defaults: function (t) {
          return t && t.ease && (t.ease = eB(t.ease, R.ease)), tI(R, t || {});
        },
        config: function (t) {
          return tI(A, t || {});
        },
          ...
          (n || "").split(",").forEach(function (t) {
            ...
            s &&
              (eW.prototype[e] = function (t, r, n) {
                return this.add(tv[e](t, j(r) ? r : (n = r) && {}, this), n);
              });
        },
    ...
    var rS,
      ...
      r7 = function t(e, r, n) {
        ...
        return (
          i[r] ||
          i.getPropertyValue(r.replace(rY, "-$1").toLowerCase()) ||
      ...
      nr = function () {
        "u" > typeof window &&
          window.document &&
          ((rP = (rS = window.document).documentElement),
          (rA = r4("div") || { style: {} }),
          r4("div"),
          (r5 = (r2 = ne(r2)) + "Origin"),
          (rA.style.cssText =
      ...
      nn = function (t) {
        var e,
          ...
          i = t.cloneNode(!0);
        (i.style.display = "block"), n.appendChild(i), rP.appendChild(n);
        try {
          e = i.getBBox();
        } catch (t) {}
        return n.removeChild(i), rP.removeChild(n), e;
      },
      ni = function (t, e) {
        for (var r = e.length; r--; )
          ...
          e in rF && e !== r5 && (e = r2),
            n.removeProperty
              ? (("ms" === (r = e.substr(0, 2)) ||
                  ...
                  (e = "-" + e),
                n.removeProperty(
                  "--" === r ? e : e.replace(rY, "-$1").toLowerCase()
                ))
              : n.removeAttribute(e);
        }
      },
      nu = function (t, e, r, n, i, s) {
        var a = new rp(t._pt, e, r, 0, 1, s ? r$ : rG);
      ...
      nf = function t(e, r, n, i) {
        ...
        if (g && ("height" === r || "width" === r)) {
          ...
          (g || "%" === c) &&
            ...
            (f.position = "absolute");
        return (
          h && g && (((o = tw(a)).time = eP.time), (o.width = a[d])),
      ...
      np = function (t, e, r, n) {
        ...
        if (
          ...
          (r += ""),
          "var(--" === (n += "").substring(0, 6) &&
            (n = r7(t, n.substring(4, n.indexOf(")")))),
          "auto" === n &&
            ((f = t.style[e]),
            (t.style[e] = n),
            (n = r7(t, e) || n),
          ...
          for (; (o = J.exec(n)); )
            (h = o[0]),
              ...
              h !== (f = u[y++] || "") &&
                ((l = parseFloat(f) || 0),
                (g = f.substr((l + "").length)),
                "=" === h.charAt(1) && (h = tS(l, h) + g),
                (p = parseFloat(h)),
                (_ = h.substr((p + "").length)),
                (v = J.lastIndex - _.length),
                _ ||
                  ((_ = _ || A.units[e] || g),
                  v === n.length && ((n += _), (m.e += _))),
                g !== _ && (l = nf(t, e, f, _) || 0),
                (m._pt = {
                  _next: m._pt,
                  p: d || 1 === y ? d : ",",
        ...
        } else m.r = "display" === e && "none" === n ? r$ : rG;
      ...
      nb = function (t) {
        var e = r7(t, r2);
        return nx(e) ? nv : e.substr(7).match(Z).map(tO);
      },
      nT = function (t, e) {
        var r,
          n,
        ...
        return a.svg && t.getAttribute("transform")
          ...
          : (u !== nv ||
              ...
              ((r = t.parentNode) &&
                ...
                ((s = 1), (n = t.nextElementSibling), rP.appendChild(t)),
              (u = nb(t)),
      ...
      nw = function (t, e, r, n, i, s) {
        ...
        r
          ? f !== nv &&
            ...
            (k = l))
          : ((w =
              (a = ns(t)).x + (~T[0].indexOf("%") ? (w / 100) * a.width : w)),
            (k =
      ...
      nk = function (t, e) {
        ...
        return (
          ...
          r.svg &&
            ...
            nw(t, O || Y, !!O || r.originIsAbsolute, !1 !== r.smooth, g)),
          (d = r.xOrigin || 0),
          (_ = r.yOrigin || 0),
          g !== nv &&
            ((x = g[0]),
            ...
            6 === g.length
              ? ((a = Math.sqrt(x * x + b * b)),
                ...
                (u = x || b ? rB(b, x) * rL : 0),
                (f = T || w ? rB(T, w) * rL + u : 0) &&
                  (o *= Math.abs(Math.cos(f * rI))),
                r.svg &&
                  ((n -= d - (d * x + _ * T)), (i -= _ - (d * b + _ * w))))
              : ((F = g[6]),
                (D = g[7]),
                (P = g[8]),
                (E = g[9]),
                ...
                (l = (m = rB(F, R)) * rL),
                m &&
                  ((O = k * (v = Math.cos(-m)) + P * (y = Math.sin(-m))),
                  (C = M * v + E * y),
                  (S = F * v + R * y),
                  (P = -(k * y) + P * v),
                  (E = -(M * y) + E * v),
                ...
                (c = (m = rB(-T, R)) * rL),
                m &&
                  ((O = x * (v = Math.cos(-m)) - P * (y = Math.sin(-m))),
                  (C = b * v - E * y),
                  (S = T * v - R * y),
                  (z = w * y + z * v),
                  (x = O),
                ...
                (f = Math.abs((m = rB(k, M))) > 2e-4 ? m * rL : 0),
                (p = z ? 1 / (z < 0 ? -z : z) : 0)),
            r.svg &&
          ...
          (r.force3D = A.force3D),
          (r.renderTransform = r.svg ? nE : rz ? nP : nC),
          (r.uncache = 0),
          r
        );
      },
      ...
      nP = function (t, e) {
        ...
        if (v && (c !== nS || l !== nS)) {
          var b,
            ...
            w = Math.sin(T),
            k = Math.cos(T);
          (s = nO(m, s, -(w * (b = Math.cos((T = parseFloat(c) * rI))) * v))),
      ...
      nE = function (t, e) {
        ...
        (h = parseFloat(h)),
          ...
          h || p
            ? ((h *= rI),
              ...
              p &&
                ...
                (s *= a),
                d &&
                  ((r *= a = Math.sqrt(1 + (a = Math.tan(d)) * a)), (n *= a))),
              (r = tO(r)),
              (n = tO(n)),
              (i = tO(i)),
              (s = tO(s)))
          ...
          (v || y || x || b) &&
            ...
            (k = tO(k + y - (v * n + y * s) + b))),
          (u || l) &&
            ((w = tO(w + (u / 100) * (a = m.getBBox()).width)),
      ...
      nA = function (t, e, r, n, i) {
        var s,
          a,
          o = Y(i),
          u = parseFloat(i) * (o && ~i.indexOf("rad") ? rL : 1) - n,
          l = n + u + "deg";
        return (
          o &&
            ("short" === (s = i.split("_")[1]) &&
            ...
            "cw" === s && u < 0
              ...
              : "ccw" === s &&
                u > 0 &&
                (u = ((u - 36e9) % 360) - 360 * ~~(u / 360))),
          (t._pt = a = new rp(t._pt, e, r, n, u, rq)),
          (a.e = l),
          (a.u = "deg"),
          t._props.push(r),
          a
      ...
      nD = function (t, e, r) {
        ...
        rF))
          (s = c[i]) !== (a = n[i]) &&
            ...
            (u = parseFloat(a)),
            (t._pt = new rp(t._pt, n, i, o, u - o, rj)),
            (t._pt.u = l || 0),
            t._props.push(i));
        nR(n, c);
      };
            ...
            if (
              ...
              if (
                ...
                if (
                  ...
                  if (
                    "calc(" ===
                    (a = r7(t, a.substring(4, a.indexOf(")")))).substring(0, 5)
                  ) {
                ...
                if (
                  ...
                  (this._pt = new rp(
                    ...
                    "scaleY",
                    m.scaleY,
                    (d ? tS(m.scaleY, d + o) : o) - m.scaleY || 0,
                    rj
                  )),
                    (this._pt.u = 0),
                    T.push("scaleY", f),
              ...
              if (
                ...
                (h = (s + "").substr((u + "").length)),
                  ...
                  (this._pt.u = p || 0),
                  _ && b !== a
                    ? ((this._pt.b = s), (this._pt.e = b), (this._pt.r = rH))
                    : h !== p &&
                      "%" !== p &&
    ...
    nF.core.Tween, t.s(["default", 0, nF, "gsap", 0, nF], 89970);
  },
  95057,
  (t, e, r) => {
    "use strict";
  ...
  (t, e, r) => {
    ...
    function m(e) {
      ...
      let i,
        s,
        m,
        [y, x] = (0, o.useOptimistic)(d.IDLE_LINK_STATUS),
        b = (0, o.useRef)(null),
        {
          href: T,
          as: w,
      ...
      let Y = o.default.useContext(l.AppRouterContext),
        N = !1 !== M,
        X =
          !1 !== M
            ? null === (n = M) || "auto" === n
            ...
            : g.FetchStrategy.PPR,
        U = "string" == typeof (r = w || T) ? r : (0, u.formatUrl)(r);
      if (D) {
      ...
      let j = D ? s && "object" == typeof s && s.ref : L,
        q = o.default.useCallback(
          (t) => (
            null !== Y &&
              (b.current = (0, d.mountLinkInstance)(t, U, Y, X, N, x)),
            () => {
              b.current &&
                ((0, d.unmountLinkForCurrentNavigation)(b.current),
                (b.current = null)),
                (0, d.unmountPrefetchableInstance)(t);
            }
          ),
          [N, U, Y, X, x]
        ),
        W = {
          ref: (0, c.useMergedRef)(q, j),
          onClick(e) {
            D || "function" != typeof E || E(e),
              ...
              !Y ||
                e.defaultPrevented ||
                (function (e, r, n, i, s, a, u) {
                  if ("u" > typeof window) {
                    let l,
                      { nodeName: c } = e.currentTarget;
                    if (
                      ("A" === c.toUpperCase() &&
                        (((l = e.currentTarget.getAttribute("target")) &&
                          "_self" !== l) ||
                          e.metaKey ||
                          e.ctrlKey ||
                          e.shiftKey ||
                    ...
                    let { dispatchNavigateAction: f } = t.r(99781);
          ...
          onMouseEnter(t) {
            D || "function" != typeof A || A(t),
              ...
              Y && N && (0, d.onNavigationIntent)(t.currentTarget, !0 === I);
          },
      ...
      return (
        (0, f.isAbsoluteUrl)(U)
          ? (W.href = U)
          : (D && !O && ("a" !== s.type || "href" in s.props)) ||
            (W.href = (0, h.addBasePath)(U)),
        (m = D
          ? o.default.cloneElement(s, W)
          : (0, a.jsx)("a", { ...B, ...W, children: i })),
        (0, a.jsx)(v.Provider, { value: y, children: m })
      );
    }
    t.r(84508);
    let v = (0, o.createContext)(d.IDLE_LINK_STATUS),
      y = () => (0, o.useContext)(v);
    ("function" == typeof r.default ||
      ("object" == typeof r.default && null !== r.default)) &&
      void 0 === r.default.__esModule &&
      ...
      (function (t) {
        ...
        var e,
          ...
          P = function (t, e) {
            var r = function r(i) {
              if (i || 0 === i) {
                ...
                (e || m.cache !== r.cacheID || x("ref")) &&
                  ((r.cacheID = m.cache), (r.v = t()));
              return r.v + r.offset;
            };
          ...
          z = function (t, r) {
            ...
            var o = m.indexOf(t),
              u = a === A.sc ? 1 : 2;
            ~o || (o = m.push(t) - 1), m[o + u] || k(t, "scroll", S);
            var l = m[o + u],
              c =
                l ||
                (m[o + u] =
        ...
        var N = (function () {
          ...
          return (
            (c.prototype.init = function (t) {
              r || Y(e) || console.warn("Please gsap.registerPlugin(Observer)"),
                l || B();
              var c = t.tolerance,
                d = t.dragMinimum,
                _ = t.type,
              ...
              var tm,
                ...
                tY = function (t, e) {
                  return (
                    ((tk.event = t) && C && D(t.target, C)) ||
                    (e && tR && "touch" !== t.pointerType) ||
                    (ti && ti(t, e))
                  );
                },
                tN = function () {
                  var t = (tk.deltaX = I(tF)),
                    e = (tk.deltaY = I(tL)),
                    r = Math.abs(t) >= c,
                    n = Math.abs(e) >= c;
                  Z && (r || n) && Z(tk, t, e, tF, tL),
                    r &&
                      (H && tk.deltaX > 0 && H(tk),
                      V && tk.deltaX < 0 && V(tk),
                      K && K(tk),
                ...
                tU = function (t, e) {
                  t_ &&
                    !tw &&
                    ((tk.axis = tw = Math.abs(t) > Math.abs(e) ? "x" : "y"),
                    (tT = !0)),
                    "y" !== tw && ((tF[2] += t), tk._vx.update(t, !0)),
                    "x" !== tw && ((tL[2] += e), tk._vy.update(e, !0)),
                    x ? tm || (tm = requestAnimationFrame(tN)) : tN();
                },
                tj = function (t) {
                  if (!tY(t, 1)) {
                    ...
                    (tk.x = e),
                      ...
                      (s ||
                        ((n || i) &&
                          (Math.abs(tk.startX - e) >= d ||
                            Math.abs(tk.startY - r) >= d))) &&
                        (ty || (ty = s ? 2 : 1),
                        s || (tk.isDragging = !0),
                        tU(n, i));
                  }
                ...
                tW = (tk.onRelease = function (t) {
                  if (!tY(t, 1)) {
                    ...
                    var r = !isNaN(tk.y - tk.startY),
                      ...
                      s =
                        i &&
                        (Math.abs(tk.x - tk.startX) > 3 ||
                          Math.abs(tk.y - tk.startY) > 3),
                      a = L(t);
                    !s &&
                      r &&
                      (tk._vx.reset(),
              ...
              (tv = tk._dc =
                ...
                (tk.enable = function (t) {
                  return (
                    !tk.isEnabled &&
                      (k(tD ? tz : m, "scroll", S),
                      _.indexOf("scroll") >= 0 &&
                        k(tD ? tz : m, "scroll", tG, tC, tp),
                      _.indexOf("wheel") >= 0 && k(m, "wheel", t$, tC, tp),
                      ((_.indexOf("touch") >= 0 && o) ||
                        _.indexOf("pointer") >= 0) &&
                        (k(m, h[0], tq, tC, tp),
                        k(tz, h[2], tW),
                        ...
                        td && k(m, "click", tB, !0, !0),
                        tf && k(m, "click", tJ),
                        ta && k(tz, "gesturestart", tH),
                        to && k(tz, "gestureend", tV),
                        te && k(m, u + "enter", tQ),
                        tr && k(m, u + "leave", tZ),
                        tn && k(m, u + "move", tK)),
                      (tk.isEnabled = !0),
                ...
                (tk.disable = function () {
                  tk.isEnabled &&
                    ...
                    }).length || M(tD ? tz : m, "scroll", S),
                    tk.isPressed &&
                      (tk._vx.reset(),
                      tk._vy.reset(),
                      M(ts ? m : tz, h[1], tj, !0)),
                    M(tD ? tz : m, "scroll", tG, tp),
                    M(m, "wheel", t$, tp),
                    M(m, h[0], tq, tp),
                    M(tz, h[2], tW),
                    M(tz, h[3], tW),
        ...
        var X,
          ...
          tE = function (t, e, r) {
            var n =
              tq(t) && ("clamp(" === t.substr(0, 6) || t.indexOf("max") > -1);
            return (
              (r["_" + e + "Clamp"] = n), n ? t.substr(6, t.length - 7) : t
            );
          },
          tA = function (t, e) {
            return e && (!tq(t) || "clamp(" !== t.substr(0, 6))
              ? "clamp(" + t + ")"
              : t;
          },
          tR = function () {
          ...
          tI = function () {
            return X || (tL() && (X = window.gsap) && X.registerPlugin && X);
          },
          tB = function (t) {
            return !!~V.indexOf(t);
          },
          ...
          tN = function (t) {
            return (
              ...
              (tB(t)
                ? function () {
                    return (eV.width = j.innerWidth), (eV.height = tm), eV;
                  }
                : function () {
                    return er(t);
                  })
          ...
          ed = function (t, e, r, n, i, s, a, o) {
            var u = i.startColor,
              ...
              d = tB(r) || "fixed" === T(r, "pinType"),
              _ = -1 !== t.indexOf("scroller"),
              g = d ? H : "IFRAME" === r.tagName ? r.contentDocument.body : r,
              m = -1 !== t.indexOf("start"),
              v = m ? u : l,
              y =
                "border-color:" +
          ...
          em = {},
          ev = function () {
            return tO() - tS > 34 && (tb || (tb = requestAnimationFrame(eB)));
          },
          ey = function () {
            (tl && tl.isPressed && !(tl.startX > H.clientWidth)) ||
              (m.cache++,
          ...
          ex = function () {
            (th = j.innerWidth), (tf = j.innerHeight);
          },
          eb = function (t) {
            m.cache++,
              (!0 === t ||
                (!J &&
                  ...
                  (!tc ||
                    th !== j.innerWidth ||
                    Math.abs(j.innerHeight - tf) > 0.25 * j.innerHeight))) &&
                G.restart(!0);
          },
          eT = {},
          ew = [],
          ...
          eC = function (t) {
            for (var e = 0; e < eO.length; e += 5)
              (!t || (eO[e + 4] && eO[e + 4].query === t)) &&
                ...
                eO[e].getBBox &&
                  eO[e].setAttribute("transform", eO[e + 2] || ""),
                (eO[e + 3].uncache = 1));
          },
          eS = function () {
          ...
          eE = function (t, e) {
            m.cache++,
              ...
              tq(t) && (j.history.scrollRestoration = t_ = t);
          },
          eA = 0,
          eR = function () {
            if (tw !== eA) {
          ...
          eD = function () {
            H.appendChild(tg),
              (tm = (!tl && tg.offsetHeight) || j.innerHeight),
              H.removeChild(tg);
          },
          ez = function (t) {
            return $(
          ...
          eB = function (t) {
            if (2 === t || (!tT && !tv)) {
              ...
              if (
                ...
                tT || (eL = i),
                n &&
                  (tS && !tt && r - tS > 200 && ((tS = 0), eM("scrollEnd")),
                  (Q = tC),
                  (tC = r)),
                eI < 0)
              ) {
          ...
          eU = function (t, e, r, n) {
            if (!t._gsap.swappedIn) {
              for (var i, s = eY.length, a = e.style, o = t.style; s--; )
                a[(i = eY[s])] = r[i];
              (a.position =
          ...
          eq = function (t) {
            if (t) {
              var e,
                ...
                s = 0;
              for (
                (t.t._gsap || X.core.getCache(t.t)).uncache = 1;
                s < i;
                s += 2
              )
                (r = t[s + 1]),
                  ...
                  r
                    ? (n[e] = r)
                    : n[e] &&
                      n.removeProperty(e.replace(ej, "-$1").toLowerCase());
            }
          },
          eW = function (t) {
          ...
          eG = function (t, e, r, n, i, s, a, o, u, l, c, f, h, p) {
            ...
            var d,
              ...
              g,
              m = h ? h.time() : 0;
            if ((h && h.seek(0), isNaN(t) || (t *= 1), tH(t)))
              h &&
                (t = X.utils.mapRange(
            ...
            if ((p && ((o[p] = t || -0.001), t < 0 && (t = 0)), s)) {
              ...
              (d = "scroll" + n.d2),
                e_(
                  ...
                  (k && w > 20) ||
                    (!k &&
                      (c ? Math.max(H[d], W[d]) : s.parentNode[d]) <= w + 1)
                ),
                c &&
                  ((u = er(a)),
                  c &&
            ...
            return (
              (t.prototype.init = function (e, r) {
                ...
                var n,
                  ...
                  tl,
                  tc = (e = ee(
                    tq(e) || tH(e) || e.nodeType ? { trigger: e } : e,
                    ef
                  )),
                  tf = tc.onUpdate,
                  th = tc.toggleClass,
                ...
                if (
                  ...
                  (tC *= 45),
                  (eC.scroller = eh),
                  (eC.scroll = tQ ? tQ.time.bind(tQ) : eF),
                  (u = eF()),
                  (eC.vars = e),
                  (r = r || e.animation),
                  "refreshPriority" in e &&
                    ((ta = 1), -9999 === e.refreshPriority && (tk = eC)),
                  ...
                  r &&
                    ...
                    tp || (tp = r.vars.id)),
                  tI &&
                    ((!tV(tI) || tI.push) && (tI = { snapTo: tI }),
                    "scrollBehavior" in H.style &&
                      X.set(ev ? [H, W] : eh, { scrollBehavior: "auto" }),
                    m.forEach(function (t) {
                      return (
                        tW(t) &&
                        t.target === (ev ? q.scrollingElement || W : eh) &&
                        (t.smooth = !1)
                      );
                    }),
                    (o = tW(tI.snapTo)
                      ...
                      ? function (t, e) {
                          return es(tI.snapTo)(
                            t,
                            tO() - eD < 500 ? 0 : e.direction
                          );
                        }
                      : X.utils.snap(tI.snapTo)),
                    (te = tV((te = tI.duration || { min: 0.1, max: 2 }))
                      ? K(te.min, te.max)
                      : K(te, te)),
                    (tn = X.delayedCall(tI.delay || Z / 2 || 0.1, function () {
                      var t = eF(),
                        e = tO() - eD < 500,
                        n = s.tween;
                      if (
                        ...
                        var i,
                          ...
                          h = e ? 0 : ((l - V) / (tO() - Q)) * 1e3 || 0,
                          p = X.utils.clamp(-u, 1 - u, (tK(h / 2) * h) / 0.185),
                        ...
                        if (
                          ...
                          if (n && !n._initted && n.data <= tK(a - t)) return;
                          !1 === tI.inertia && (p = i - u),
                            s(
                              a,
                              {
                      ...
                      } else eC.isActive && eA !== t && tn.restart(!0);
                    }).pause())),
                  tp && (em[tp] = eC),
                  (tl =
                    (tm = eC.trigger = R(tm || (!0 !== tv && tv))) &&
                    tm._gsap &&
                    tm._gsap.stRevert) && (tl = tl(eC)),
                  (tv = !0 === tv ? tm : R(tv)),
                  tq(th) && (th = { targets: tm, className: th }),
                  tv &&
                    (!1 === tb ||
                      tb === t6 ||
                      (tb =
                    ...
                    (a = X.core.getCache(tv)).spacer
                      ...
                      : (tj &&
                          ((tj = R(tj)) &&
                            !tj.nodeType &&
                            (tj = tj.current || tj.nativeElement),
                          (a.spacerIsNative = !!tj),
                          tj && (a.spacerState = eW(tj))),
                        (a.spacer = M = tj || q.createElement("div")),
                  ...
                  (g = tV(eM) ? ee(eM, ec) : ec),
                    ...
                    (O = d["offset" + ea.op.d2]);
                  var eL = R(T(eh, "content") || eh);
                  (h = this.markerStart = ed("start", tp, eL, ea, g, O, 0, tQ)),
                    (p = this.markerEnd = ed("end", tp, eL, ea, g, O, 0, tQ)),
                    tQ && (tu = X.quickSetter([h, p], ea.a, "px")),
                    ex ||
                      (v.length && !0 === T(eh, "fixedMarkers")) ||
                      (et(ev ? H : eh),
                      X.set([d, _], { force3D: !0 }),
                      (I = X.quickSetter(d, ea.a, "px")),
                      (Y = X.quickSetter(_, ea.a, "px")));
                }
                if (tQ) {
                  var eB = tQ.vars.onUpdate,
                    eY = tQ.vars.onUpdateParams;
                  tQ.eventCallback("onUpdate", function () {
                    eC.update(0, 0, 1), eB && eB.apply(tQ, eY || []);
                  });
                }
                if (
                  ...
                  (eC.refresh = function (n, i, a, o) {
                    if ((!J && eC.enabled) || i) {
                      if (tv && n && tS) return void eo(t, "scrollEnd", ek);
                      !tT && eS && eS(eC),
                        (J = eC),
                      ...
                      var g,
                        ...
                        tl = (eC.pinnedContainer =
                          e.pinnedContainer && R(e.pinnedContainer, eC)),
                        tc = (tm && Math.max(0, eg.indexOf(eC))) || 0,
                        tf = tc;
                      for (
                        eM &&
                        tV(a) &&
                        ((j = X.getProperty(d, ea.p)),
                        (V = X.getProperty(_, ea.p)));
                        tf-- > 0;

                      )
                        (S = eg[tf]).end || S.refresh(0, 1) || (J = eC),
                          (F = S.pin) &&
                            (F === tm || F === tv || F === tl) &&
                            !S.isReverted &&
                            (N || (N = []), N.unshift(S), S.revert(!0, !0)),
                          S !== eg[tf] && (tc--, tf--);
                      for (
                        tW(tu) && (tu = tu(eC)),
                          c =
                                ...
                                (tr = tq(tu)
                                  ...
                                  : (tQ
                                      ? X.utils.mapRange(
                                          0,
                                          tQ.duration(),
                                          tQ.scrollTrigger.start,
                                          tQ.scrollTrigger.end,
                                          c
                                        )
                                      : c) + tt),
                                (ta = tm))),
                        ...
                        (F = (S = eg[tf] || {}).pin) &&
                          ...
                          ((g =
                            S.end -
                            (eC._startClamp ? Math.max(0, S.start) : S.start)),
                          ((F === tm && S.start - S._pinPush < c) ||
                            F === tl) &&
                            isNaN(tu) &&
                            (tt += g * (1 - S.progress)),
                          F === tv && (te += g));
                      if (
                        ...
                        (g = t7(tv)),
                          (T = ea === A),
                          (v = eF()),
                          (P = parseFloat(C(ea.a)) + te),
                          !Q &&
                            f > 1 &&
                            ((U = {
                              style: (U = (ev ? q.scrollingElement || W : eh)
                                .style),
                              value: U["overflow" + ea.a.toUpperCase()],
                            }),
                            ev &&
                              "scroll" !==
                                t7(H)["overflow" + ea.a.toUpperCase()] &&
                              (U.style["overflow" + ea.a.toUpperCase()] =
                                "scroll")),
                          eU(tv, M, g),
                          (k = eW(tv)),
                          (m = er(tv, !0)),
                          ...
                          ex &&
                            (((O = {
                              top: m.top + (T ? v - c : I) + "px",
                              left: m.left + (T ? I : v - c) + "px",
                        ...
                        for (m = tm.parentNode; m && m !== H; )
                          m._pinOffset &&
                            ((c -= m._pinOffset), (f -= m._pinOffset)),
                            (m = m.parentNode);
                      N &&
                        ...
                        (eC.end = f),
                        (u = l = tT ? ti : eF()),
                        tQ || tT || (u < ti && eF(ti), (eC.scroll.rec = 0)),
                        eC.revert(!1, !0),
                        (eD = tO()),
                        ...
                        (Z ||
                          ...
                          (r &&
                            ...
                            r.totalProgress(
                              tQ && c < -0.001 && !ez
                                ? X.utils.normalize(c, f, 0)
                                : ez,
                              !0
                            ),
                          (eC.progress = Z || (u - c) / x === ez ? 0 : ez)),
                        tv &&
                          tb &&
                          (M._pinOffset = Math.round(eC.progress * D)),
                        G && G.invalidate(),
                        isNaN(j) ||
                          ((j -= X.getProperty(d, ea.p)),
                          (V -= X.getProperty(_, ea.p)),
                  ...
                  (eC.update = function (t, e, n) {
                    if (!tQ || n || t) {
                      ...
                      if (
                        ...
                        !tI || s.tween || J || tM || tn.restart(!0),
                          th &&
                            (p || (tL && y && (y < 1 || !tx))) &&
                            $(th.targets).forEach(function (t) {
                              return t.classList[i || tL ? "add" : "remove"](
                                th.className
                              );
                            }),
                          !tf || el || t || tf(eC),
                          h && !J
                            ? (el &&
                              ...
                              tZ &&
                                ...
                                G
                                  ? G.progress(1)
                                  : tG(r, "reverse" === o ? 1 : !y, 1)))
                            : el && tf && !J && tf(eC);
                      }
                      if (Y) {
                        var C = tQ
                          ? (m / tQ.duration()) * (tQ._caScrollDist || 0)
                          : m;
                        I(C + +!!d._isFlipped), Y(C);
                      }
                      tu && tu((-m / tQ.duration()) * (tQ._caScrollDist || 0));
                    }
                  }),
                  (eC.enable = function (e, r) {
                    eC.enabled ||
                      ...
                      !1 !== e && ((eC.progress = ez = 0), (u = l = eA = eF())),
                      !1 !== r && eC.refresh());
                  }),
                  ...
                  (eC.disable = function (e, r) {
                    if (
                      ...
                      for (var n = eg.length; n--; )
                        if (eg[n].scroller === eh && eg[n] !== eC) return;
              ...
              (t.disable = function (t, e) {
                (tP = 0),
                  ...
                  eu(q, "touchcancel", tz),
                  eu(H, "touchstart", tz),
                  ea(eu, q, "pointerdown,touchstart,mousedown", tR),
                  ea(eu, q, "pointerup,touchend,mouseup", tD),
                  G.kill(),
                  tj(eu);
              ...
              (t.enable = function () {
                if (
                  ...
                  if (
                    ...
                    (t_ = j.history.scrollRestoration || "auto"),
                    (eL = j.pageYOffset || 0),
                    ...
                    for (
                      a.revert ||
                        ...
                        A.m = Math.round((e = er(H)).top + A.sc()) || 0,
                        ...
                        Z = setInterval(ev, 250),
                        X.delayedCall(0.5, function () {
                          return (tM = 0);
                        }),
                        eo(q, "touchcancel", tz),
                        eo(H, "touchstart", tz),
                        ea(eo, q, "pointerdown,touchstart,mousedown", tR),
                        ea(eo, q, "pointerup,touchend,mouseup", tD),
                    ...
                    q &&
                      q.addEventListener("DOMContentLoaded", function e() {
                        t.enable(),
              ...
              (t.config = function (e) {
                ...
                (r && clearInterval(Z)) || ((Z = r) && setInterval(ev, r)),
                  "ignoreMobileResize" in e &&
                    (tc = 1 === t.isTouch && e.ignoreMobileResize),
                  "autoRefreshEvents" in e &&
                    (tj(eu) || tj(eo, e.autoRefreshEvents || "none"),
              ...
              (t.scrollerProxy = function (t, e) {
                var r = R(t),
                  ...
                  i = tB(r);
                ~n && m.splice(n, i ? 6 : 2),
                  e && (i ? v.unshift(j, e, H, e, W, e) : v.unshift(r, e));
              }),
              ...
              (t.isInViewport = function (t, e, r) {
                var n = (tq(t) ? R(t) : t).getBoundingClientRect(),
                  i = n[r ? t0 : t1] * e || 0;
                return r
                ...
                var n = t.getBoundingClientRect(),
                  ...
                  s =
                    null == e
                      ...
                      : parseFloat(e) || 0;
                return r
                  ? (n.left + s) / j.innerWidth
                  : (n.top + s) / j.innerHeight;
              }),
        ...
        (e0.version = "3.15.0"),
          ...
          (e0.batch = function (t, e) {
            ...
            for (r in e)
              i[r] =
                "on" === r.substr(0, 2) && tW(e[r]) && "onRefreshInit" !== r
                  ? o(r, e[r])
                  : e[r];
            return (
              tW(a) &&
        ...
        var e1,
          ...
          e6 = function (t, e, r, n) {
            return N.create({
              ...
              onScroll: n,
              onEnable: function () {
                return r && eo(q, N.eventTypes[0], e4, !1, !0);
              },
              onDisable: function () {
                return eu(q, N.eventTypes[0], e4, !0);
              },
            });
          },
          e9 = /(input|label|select|textarea)/i,
          e4 = function (t) {
            var e = e9.test(t.target.tagName);
          ...
          e7 = function (t) {
            ...
            return (
              ...
              (t.onPress = function () {
                ...
                var t = b;
                (b = tF(
                  ((j.visualViewport && j.visualViewport.scale) || 1) / T
                )),
                  s.pause(),
                  t !== b && e5(d, b > 1.01 || (!c && "x")),
                  (a = x()),
        ...
        (e0.sort = function (t) {
          ...
          tI() && X.registerPlugin(e0),
          (t.ScrollTrigger = e0),
          (t.default = e0),
          "u" < typeof window || window !== t
    ...
    t.s([
      ...
      ({ children: t }) => {
        let [i, s] = (0, r.useState)(!1),
          ...
          h = (0, r.useMemo)(() => i && a, [i, a]);
        return (0, e.jsx)(n.Provider, {
          value: {
            isLoaderFinished: i,
            isTransitionFinished: a,
            setLoaderFinished: c,
            setTransitionFinished: f,
            isPageReady: h,
            scrollTarget: u,
            setScrollTarget: l,
          },
  ...
  (t) => {
    ...
    t.s([
      "default",
      0,
      ({ children: t, className: r = "" }) =>
        (0, e.jsxs)("span", {
          className: `overflow-hidden  relative inline-block group ${r}`,
          children: [
            (0, e.jsx)("span", {
              className:
                "block  group-hover:-translate-y-full translate-y-0 transition-all duration-300",
              children: t,
            }),
            (0, e.jsx)("span", {
              className:
                "block absolute inset-0 w-full h-full group-hover:translate-y-0 translate-y-full transition-all duration-300",
              "aria-hidden": "true",
              children: t,
            }),
          ],
