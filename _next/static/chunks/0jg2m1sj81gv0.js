(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (t, e, i) => {
    ...
    for (var s in r) Object.defineProperty(i, s, { enumerable: !0, get: r[s] });
    function o(t) {
      let e = {};
    ...
    function a(t, ...e) {
      for (let i of e) {
        ...
        for (let [e, r] of i.entries()) t.append(e, r);
      }
      return t;
    }
  },
  ...
  (t) => {
    ...
    var r = class {
        ...
        fromTo(
          t,
          e,
          { lerp: i, duration: r, easing: s, onStart: o, onUpdate: n }
        ) {
    ...
    var c = class {
      ...
      onTouchMove = (t) => {
        ...
        (this.touchStart.x = e),
          ...
          this.emitter.emit("scroll", { deltaX: r, deltaY: s, event: t });
      };
      onTouchEnd = (t) => {
      ...
      onWheel = (t) => {
        let { deltaX: e, deltaY: i, deltaMode: r } = t,
          s = a(r, this.window.width),
          o = a(r, this.window.height);
        (e *= s),
          (i *= o),
    ...
    let h = (t) => Math.min(1, 1.001 - 2 ** (-10 * t));
    var u = class {
        _isScrolling = !1;
        _isStopped = !1;
        _isLocked = !1;
        ...
        constructor({
          ...
          (window.lenisVersion = e),
            ...
            "number" == typeof u && "function" != typeof d
              ? (d = h)
              : "function" == typeof d && "number" != typeof u && (u = 1),
            (this.options = {
              wrapper: t,
              content: i,
              eventsTarget: r,
            ...
            (this.dimensions = new s(t, i, { autoResize: x })),
        ...
        onVirtualScroll = (t) => {
          ...
          let c = this.options.prevent,
            h = Math.abs(e) >= Math.abs(i) ? "horizontal" : "vertical";
          if (
            a.find(
              (t) =>
          ...
          if ("string" == typeof m && ["top", "left", "start", "#"].includes(m))
            ...
            if (
              ...
              let e = t.getBoundingClientRect(),
                ...
                o = this.isHorizontal
                  ? Number.parseFloat(s.scrollPaddingLeft)
                  : Number.parseFloat(s.scrollPaddingTop);
              m =
        ...
        hasNestedScroll(t, { deltaX: e, deltaY: i }) {
          ...
          if (x - (b.time ?? 0) > 2e3) {
            ...
            if (
              ((b.computedStyle = e),
              (r = ["auto", "overlay", "scroll"].includes(e.overflowX)),
          ...
          if (!((r && o) || (s && n))) return !1;
          let y = Math.abs(e) >= Math.abs(i) ? "horizontal" : "vertical";
          if ("horizontal" === y)
      ...
      v = (0, d.forwardRef)(
        (
          ...
          (0, d.useImperativeHandle)(
            n,
            () => ({ wrapper: l.current, content: a.current, lenis: c }),
            [c]
          ),
            (0, d.useEffect)(() => {
              let t = new u({
                ...i,
                ...(l.current &&
                  a.current && { wrapper: l.current, content: a.current }),
                autoRaf: i?.autoRaf ?? r,
              });
              return (
                h(t),
            ...
            }, [r, JSON.stringify({ ...i, wrapper: null, content: null })]);
          let v = (0, d.useRef)([]),
            w = (0, d.useCallback)((t, e) => {
          ...
          return ((0, d.useEffect)(() => {
            if (e && c)
              return (
                f.set({ lenis: c, addCallback: w, removeCallback: g }),
                () => f.set(null)
              );
          }, [e, c, w, g]),
          (0, d.useEffect)(() => {
            if (!c) return;
            let t = (t) => {
              for (let { callback: e } of v.current) e(t);
            };
            return (
              c.on("scroll", t),
              () => {
          ...
          t)
            ? (0, p.jsx)(m.Provider, {
                value: { lenis: c, addCallback: w, removeCallback: g },
                children:
                  e && "asChild" !== e
                    ? t
                    : (0, p.jsx)("div", {
                        ref: l,
                        className: `${s} ${c?.className ?? ""}`.trim(),
                        ...o,
                        children: (0, p.jsx)("div", { ref: a, children: t }),
                      }),
              })
            : null;
        }
    ...
    t.s(
      [
        ...
        0,
        function (t, e = [], i = 0) {
          let r = (0, d.useContext)(m),
            s = (function (t) {
              let [e, i] = (0, d.useState)(t.get());
              return (0, d.useEffect)(() => t.subscribe((t) => i(t)), [t]), e;
            })(f),
            { lenis: o, addCallback: n, removeCallback: l } = r ?? s ?? w;
          return (
            (0, d.useEffect)(() => {
              if (t && n && l && o)
                return (
    ...
    t.e,
      (function (t) {
        ...
        var e,
          ...
          p = function (t, e) {
            var i = "x" === e ? "Width" : "Height",
              ...
              l = "client" + i;
            return t === r || t === s || t === o
              ? Math.max(s[n], o[n]) - (r["inner" + i] || s[l] || o[l])
              : t[n] - t["offset" + i];
          },
          m = function (t, e) {
          ...
          f = function (t, e, i, r) {
            if ((d(t) && (t = t(e, i, r)), "object" != typeof t))
              return u(t) && "max" !== t && "=" !== t.charAt(1)
                ? { x: t, y: t }
                : { y: t };
            ...
            var s,
              o = {};
            for (s in t)
              o[s] = "onAutoKill" !== s && d(t[s]) ? t[s](e, i, r) : t[s];
            return o;
          },
          v = function (t, e) {
            if (!(t = n(t)[0]) || !t.getBoundingClientRect)
              return (
            ...
            var i = t.getBoundingClientRect(),
              ...
              a = l
                ? {
                    top:
                      s.clientTop -
                      (r.pageYOffset || s.scrollTop || o.scrollTop || 0),
                    left:
                      s.clientLeft -
                      (r.pageXOffset || s.scrollLeft || o.scrollLeft || 0),
                  }
                : e.getBoundingClientRect(),
              c = { x: i.left - a.left, y: i.top - a.top };
            return !l && e && ((c.x += m(e, "x")()), (c.y += m(e, "y")())), c;
          },
          ...
          x = {
            ...
            init: function (t, s, o, n, c) {
              i || g();
              var h = e.getProperty(t, "scrollSnapType");
              (this.isWin = t === r),
                (this.target = t),
                (this.tween = o),
                (s = f(s, n, t, c)),
                (this.vars = s),
                (this.autoKill = !!("autoKill" in s ? s : l).autoKill),
                (this.getX = m(t, "x")),
                (this.getY = m(t, "y")),
                (this.x = this.xPrev = this.getX()),
                (this.y = this.yPrev = this.getY()),
                a || (a = e.core.globals().ScrollTrigger),
            ...
            render: function (t, e) {
              for (
                ...
                h.r(t, h.d), (h = h._next);
              (i = w || !e.skipX ? e.getX() : f),
                (o = (s = w || !e.skipY ? e.getY() : v) - v),
                (n = i - f),
                (c = l.autoKillThreshold),
                e.x < 0 && (e.x = 0),
                e.y < 0 && (e.y = 0),
                m &&
                  (!e.skipX &&
                ...
                w
                  ? r.scrollTo(e.skipX ? i : e.x, e.skipY ? s : e.y)
        ...
        (x.max = p),
          ...
          (x.buildGetter = m),
          (x.config = function (t) {
            for (var i in (l || g() || (l = e.config()), t)) l[i] = t[i];
          }),
          h() && e.registerPlugin(x),
          (t.ScrollToPlugin = x),
          (t.default = x),
  ...
  (t) => {
    ...
    function d() {
      ...
      o)
        ? (0, e.jsx)("div", {
            className:
              "fixed bottom-[2vw] max-md:bottom-[3vw] left-1/2 -translate-x-1/2 z-997 w-[32vw] max-w-[98vw] min-w-[290px] max-md:w-[99vw] max-md:px-[2vw] pointer-events-none",
            role: "status",
            "aria-live": "polite",
            children: (0, e.jsxs)("div", {
              ...
              className:
                "pointer-events-auto bg-white/90 backdrop-blur-md text-black border border-beige/30 rounded-2xl shadow-lg px-[1.6vw] py-[1.1vw] max-md:px-[4vw] max-md:py-[4vw] max-md:rounded-xl max-md:gap-3 overflow-hidden flex flex-col gap-1.5",
              style: {
              ...
              children: [
                (0, e.jsxs)("div", {
                  className:
                    "flex items-center gap-2 mb-[.5vw] max-md:gap-2.5 max-md:mb-[1.3vw]",
                  children: [
                    (0, e.jsx)("span", {
                      className:
                        "inline-flex items-center justify-center bg-mustard/20 rounded-full p-1 mr-1 max-md:p-[2.2vw] max-md:mr-[1vw]",
                    ...
                    (0, e.jsx)("span", {
                      className:
                        "font-mouse-memoirs uppercase tracking-[.16em] text-[.88vw] max-md:text-[4vw] text-black/85 max-md:leading-tight",
                      children: "Cookies in use",
                    }),
                  ],
                }),
                (0, e.jsxs)("div", {
                  className:
                    "flex items-center w-full gap-3 max-md:flex-col max-md:items-stretch max-md:gap-[2vw] max-md:w-full",
                  children: [
                    (0, e.jsx)("p", {
                      className:
                        "font-mouse-memoirs text-[.96vw] max-md:text-[4vw] text-black/95 leading-normal mr-auto max-md:mr-0 max-md:mb-[2vw] max-md:text-left",
                      children: "We use cookies to improve your experience.",
                    }),
                    (0, e.jsxs)("div", {
                      className:
                        "flex items-center gap-2 shrink-0 max-md:mt-0 max-md:w-full max-md:gap-[3vw]",
                      children: [
                        (0, e.jsx)("button", {
                          ...
                          className:
                            "font-mouse-memoirs cursor-pointer flex items-center justify-center uppercase tracking-wide text-[.88vw] max-md:text-[3.5vw] px-[1vw] py-[.43vw] max-md:px-[2.5vw] max-md:py-[2.4vw] rounded-full border border-black/15 hover:border-mustard hover:bg-mustard/10 transition-colors duration-200 w-fit max-md:flex-1",
    ...
    var p = t.i(62987);
    s.default.registerPlugin(o.ScrollToPlugin, n.ScrollTrigger),
      t.s(
        [
          "default",
          0,
          function () {
            let [t, o] = (0, r.useState)(!1),
              [u, m] = (0, r.useState)(!1),
              f = (0, r.useRef)(null),
              v = (0, r.useRef)(null),
              w = (0, r.useRef)(null),
              ...
              z = (0, a.useLenis)(
                ({ scroll: e }) => {
                  ...
                  0 === E.current &&
                    ...
                    s.default.set(i, { willChange: "transform" });
                  let r = () => {
                    T.current ||
                      ((T.current = !0),
                      s.default.to(i, {
            ...
            (0, r.useEffect)(() => {
              m(!1);
              let t = document.querySelectorAll('[data-nav-dark="true"]'),
                e = [];
              return (
                t.forEach((t) => {
                  let i = n.ScrollTrigger.create({
                    trigger: t,
                    start: "top 5%",
                    end: "bottom 5%",
                    onEnter: () => m(!0),
            ...
            let O = (t) => {
              ...
              let e = (function (t) {
                ...
                if ("#map" === t) {
                  let t = window.matchMedia("(max-width: 1025px)").matches;
                  return document.querySelector(
                    t ? "#map-mobile" : "#map-desktop"
                  );
                }
                return document.querySelector(t);
              })(t);
              if (!e) return;
              let i = w.current?.offsetHeight ?? 0;
              s.default.to(window, {
                duration: 0.9,
                ease: "power3.inOut",
                scrollTo: { y: e, offsetY: i + 12 },
              });
            };
            return (
              (0, r.useEffect)(() => {
                ...
                if (e && i) {
                  if (!x.current) {
                    s.default.set(e, { opacity: 0, pointerEvents: "none" }),
                      s.default.set(i, {
                        opacity: 0,
                        scale: 0.3,
                        transformOrigin: "top right",
                      });
                    let t = s.default.timeline({
                      paused: !0,
                      defaults: { overwrite: "auto" },
                    });
                    t
                      .add(() => s.default.set(e, { pointerEvents: "auto" }), 0)
                      .to(
                        e,
                      ...
                      t.eventCallback("onReverseComplete", () => {
                        s.default.set(e, { pointerEvents: "none" });
                      }),
                      (x.current = t);
                  }
                  t ? x.current.play() : x.current.reverse();
                }
              }, [t]),
              (0, r.useEffect)(() => {
                let e = b.current,
                ...
                let o = () => {
                  k.current?.kill(),
                    ...
                    s.default.set(e, { top: 0, bottom: "auto" }),
                    s.default.set(i, { opacity: 1, scaleX: 1 }),
                    s.default.set(r, { top: "auto", bottom: 0 });
                  let t = s.default.timeline({
                    paused: !0,
                ...
                (k.current = o()), t && k.current.progress(1);
                let n = 0,
                  l = () => {
                    clearTimeout(n),
                      (n = window.setTimeout(() => {
                        let t = k.current?.progress() ?? 0;
                        (k.current = o()), k.current.progress(t);
                      }, 120));
                  };
                return (
              ...
              (0, r.useEffect)(() => {
                k.current && (t ? k.current.play() : k.current.reverse());
              }, [t]),
              (0, r.useEffect)(() => {
                if (z)
                  return (
              ...
              (0, r.useEffect)(() => {
                if (!t) return;
                let e = (t) => {
                  f.current && !f.current.contains(t.target) && o(!1);
                };
                return (
              ...
              (0, e.jsxs)(e.Fragment, {
                children: [
                  ...
                  (0, e.jsxs)("nav", {
                    ref: w,
                    className:
                      "fixed top-0 left-0 w-full z-999 flex items-center justify-between px-[2.5vw] max-md:px-[4vw] py-[1vw] max-md:py-[4vw]",
                    children: [
                      (0, e.jsx)(i.default, {
                        href: "/",
                        onClick: (t) => {
                          "/" === N && (t.preventDefault(), O("#hero"));
                        },
                        className:
                      ...
                      (0, e.jsxs)("div", {
                        className:
                          "flex items-center gap-[1vw] max-md:gap-[3vw]",
                        children: [
                          (0, e.jsx)(p.default, {
                            href: "/menu",
                            "data-cursor-hide": "true",
                            ...
                            children: [
                              (0, e.jsxs)("button", {
                                ...
                                children: [
                                  ...
                                  (0, e.jsxs)("div", {
                                    className:
                                      "relative shrink-0 w-[1.2vw] h-[1.2vw] max-md:w-[3.5vw] max-md:h-[3.5vw]",
                                    "aria-hidden": "true",
                                    children: [
                                      (0, e.jsx)("span", {
                                        ref: b,
                              ...
                              (0, e.jsxs)("div", {
                                ...
                                role: "menu",
                                className:
                                  "absolute top-[calc(100%+1vw)] right-0 w-[18vw] max-md:w-[91vw] bg-red rounded-[1.2vw] max-md:rounded-[4vw] p-[2vw] max-md:mt-[5vw] max-md:p-[6vw] shadow-[0_1vw_3vw_rgba(27,27,27,.25)]",
                                style: {
                                  opacity: 0,
                                  scale: 0.3,
                                  transformOrigin: "top right",
                                ...
                                children: [
                                  (0, e.jsx)("div", {
                                    ref: v,
                                    className:
                                      "flex flex-col gap-[.6vw] max-md:gap-[2vw]",
                                    children: [
                                      { label: "Home", href: "/" },
                                      ...
                                      (0, e.jsx)(
                                        i.default,
                                        {
                                          ...
                                          className:
                                            "font-modak text-[2.4vw] max-md:text-[8vw] text-beige leading-[1.1] uppercase hover:text-mustard hover:scale-105 transition-transform duration-300  transform inline-block",
                                          children: t.label,
                                        },
                                        t.label
                                      )
                                  ...
                                  (0, e.jsx)("div", {
                                    className:
                                      "mt-[1.5vw] max-md:mt-[4vw] pt-[1vw] max-md:pt-[3vw] border-t border-beige/20",
                                    children: (0, e.jsx)("p", {
                                      className:
                                        "font-mouse-memoirs text-[.9vw] max-md:text-[3.5vw] text-beige/85 uppercase tracking-[.2em]",
                                      children: "Est. 1997 — Navarra, España",
                                    }),
                                  }),
                                ],
                              }),
